...
export default function CustomerOTPScreen() {
  ...
  useEffect(() => {
    // Load customer info from storage
    Promise.all([
      AsyncStorage.getItem('pendingCustomerPhone'),
      AsyncStorage.getItem('pendingCustomerName')
    ]).then(([phone, name]) => {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      await AsyncStorage.multiRemove(['pendingCustomerName', 'pendingCustomerPhone']);
